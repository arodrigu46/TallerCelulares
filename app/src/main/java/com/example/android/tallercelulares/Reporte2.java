package com.example.android.tallercelulares;
...
public class Reporte2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < celular.size() ; i++) {
            ...
            if(celular.get(i).getMarca().equals("Samsung")&& ((celular.get(i).getRam().equals("2GB"))||celular.get(i).getRam().equals("3GB")||celular.get(i).getRam().equals("4GB"))){
